...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="#" onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="fa fa-user fa-fw w3-margin-right"></i>RESTRICT USER</a> 
...
<div class="w3-main" style="margin-left:300px">
  ...
  <header id="portfolio">
    ...
    <?php
    	if(isset($_GET['user'])){
    		...
    		echo "<h3>#".$_GET['user']."</h3><i>User_Name</i><p> Member Since : <i>@timestamp</i><p><hr>";
    		echo "Activities related to this user<br><br><br><br>";
    	}
    ?>
  ...
  <h3>User Permission</h3><hr>
	<form action="restrict_user.php" method="post">
		...
		<input type="checkbox" id="access" name="access" value="yes">
  		<label for="acess"> Book Access</label><br>
  	<input type="checkbox" id="down" name="down" value="yes">
  		<label for="down"> Book Download</label><br>
  	<input type="checkbox" id="up" name="up" value="yes">
  		<label for="up"> Book Upload</label><br>
  	</div>
  	<br>
  ...
  <div style="padding: 16px 16px 16px 32px">
	<h3>Search User</h3><hr>
	<form action="admin-at-user.php" method="post">
		<input type="text" placeholder="Search User Name" name="uname">
		Or, <input type="text" placeholder="Search User Id" name="uid">  
